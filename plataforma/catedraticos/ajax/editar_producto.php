<?php
    ...
    $sql = "UPDATE TB_NOTAS SET SEM_NOTA='".$prod_code."', FECHA_NOTA='".$prod_name."', PP_NOTA ='".$lastname."', SP_NOTA='".$stock."', ACT_NOTA='".$price."', EF_NOTA='".$vecindad."', ID_CURSO='".$lugar."', ID_ALUMNO='".$fecha."' WHERE ID_NOTA='".$id."' ";
