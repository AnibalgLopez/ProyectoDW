<?php
    ...
    $sql = "INSERT INTO TB_CATEDRATICO(ID_CATEDRATICO, NOM_CATEDRATICO, APE_CATEDRATICO, TEL_CATEDRATICO, EMAIL_CATEDRATICO, DIR_CATEDRATICO, ID_USUARIO) VALUES ('$prod_code','$prod_name', '$lastname', '$prod_ctry','$stock','$price', '$vecindad')";
    $query = mysqli_query($mysqli,$sql);
    // if product has been added successfully
    if ($query) {
        $messages[] = "El catedratico ha sido guardado con éxito.";
    } else {
