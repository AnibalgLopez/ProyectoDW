			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						while($row = mysqli_fetch_array($query)){	
							$product_id=$row['ID_CURSO'];
							$prod_code=$row['NOM_CURSO'];
                            $prod_name=$row['ID_CARRERA'];
							$finales++;
						?>	
						<tr class="<?php;?>">
							...
							<td>
								<a href="#"  data-target="#editProductModal" class="edit" data-toggle="modal" data-code='<?php echo $prod_code;?>' data-name="<?php echo $prod_name?>" data-id="<?php echo $product_id; ?>"><i class="material-icons" data-toggle="tooltip" title="Editar" >&#xE254;</i></a>
