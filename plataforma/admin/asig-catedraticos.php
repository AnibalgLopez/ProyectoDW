...
<body>    
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2><b>Asignaciones Catedráticos</b></h2>
					</div>
					<div class="col-sm-6">
	...
	<!-- Edit Modal HTML -->
	<?php include "php/modal_add_asig-cat.php";?>
	<!-- Edit Modal HTML -->
	<?php include "php/modal_edit_asig-cat.php";?>
	<!-- Delete Modal HTML -->
	<?php include "php/modal_delete_asig-cat.php";?>

	<?php include 'php/pie-pagina.php';?>
	
	<script src="js/script_asig-cat.js"></script>
</body>
